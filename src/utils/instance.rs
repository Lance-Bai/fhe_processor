...
lazy_static! {
pub static ref TriviumSet: ProcessorParam<u64> = ProcessorParam::new(
        LweDimension(534), // lwe_dimension
        StandardDev(4.19221e-4), // lwe_modular_std_dev
